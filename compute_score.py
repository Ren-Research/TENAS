...
def prune_func_rank(xargs, epoch, arch_parameters, model_config, model_config_thin, loader, lrc_model, search_space, precision=10, prune_number=1):
    ...
    ntk_all.append(ntk_delta)  # change of ntk
    network.zero_grad()
    ...
    with torch.no_grad():
        ...
        regions_all.append(linear_regions)
...
def main(xargs):
    ...
    import pickle
    all_arch = pickle.load(open("./all_arch.pickle", "rb"))
    ...
    while epoch < 15624:
        ...
        arch_parameters, op_pruned = prune_func_rank(xargs, epoch, all_arch[epoch], model_config, model_config_thin, train_loader, lrc_model, search_space,
